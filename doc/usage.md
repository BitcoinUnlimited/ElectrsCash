...
The config files must be in the Toml format. These config files are (from lowest priority to highest): `/etc/electrscash/config.toml`, `~/.electrscash/config.toml`, `./electrscash.toml`.
